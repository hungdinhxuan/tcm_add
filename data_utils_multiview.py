...
class Dataset_var_eval2(Dataset):
    def __init__(self, list_IDs, base_dir, format='.flac', max_length=160000):
        '''self.list_IDs	: list of strings (each string: utt key),'''
        self.list_IDs = list_IDs
        self.base_dir = base_dir
        self.format = format
        # maximum length of input audio to be used in training and evaluation  # 160000 samples = 4 seconds
